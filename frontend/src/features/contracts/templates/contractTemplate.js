 ...
 * This file exports the contract template as a string to avoid fetch issues in development
 */

export const contractTemplate = `# CONTRATO DE PRESTACION DE SERVICIOS
