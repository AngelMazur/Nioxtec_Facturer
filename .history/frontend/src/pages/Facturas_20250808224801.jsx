...
export default function Facturas() {
  ...
  // Duplicar factura: carga sus datos en el formulario para editar número/fecha y guardar
  const duplicateInvoice = (inv) => {
    setForm({
      ...
      items: inv.items?.map(it => ({ description: it.description, units: it.units, unit_price: it.unit_price, tax_rate: it.tax_rate })) || [],
    })
